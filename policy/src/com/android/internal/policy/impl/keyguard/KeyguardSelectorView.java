...
import static com.android.internal.util.tripndroid.AwesomeConstants.*;
import com.android.internal.util.tripndroid.TripndroidRibbonHelper;
import com.android.internal.util.tripndroid.LockScreenHelpers;
...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
    ...
    private void launchAction(String action) {
        ...
        case ACTION_APP:
            ...
            mCallback.dismiss(false);
            Intent i = new Intent();
            i.setAction("com.android.systemui.tripndroid.LAUNCH_ACTION");
    ...
    protected void onFinishInflate() {
        ...
        mRibbon.addView(TripndroidRibbonHelper.getRibbon(mContext,
            Settings.System.getArrayList(cr,
                Settings.System.RIBBON_TARGETS_SHORT[TripndroidRibbonHelper.LOCKSCREEN]),
            Settings.System.getArrayList(cr,
                Settings.System.RIBBON_TARGETS_LONG[TripndroidRibbonHelper.LOCKSCREEN]),
            Settings.System.getArrayList(cr,
                Settings.System.RIBBON_TARGETS_ICONS[TripndroidRibbonHelper.LOCKSCREEN]),
            Settings.System.getBoolean(cr,
                Settings.System.ENABLE_RIBBON_TEXT[TripndroidRibbonHelper.LOCKSCREEN], true),
            Settings.System.getInt(cr,
                Settings.System.RIBBON_TEXT_COLOR[TripndroidRibbonHelper.LOCKSCREEN], -1),
            Settings.System.getInt(cr,
                Settings.System.RIBBON_ICON_SIZE[TripndroidRibbonHelper.LOCKSCREEN], 0),
            Settings.System.getInt(cr,
                Settings.System.RIBBON_ICON_SPACE[TripndroidRibbonHelper.LOCKSCREEN], 5),
            Settings.System.getBoolean(cr,
                Settings.System.RIBBON_ICON_VIBRATE[TripndroidRibbonHelper.LOCKSCREEN], true),
            Settings.System.getBoolean(cr,
                Settings.System.RIBBON_ICON_COLORIZE[TripndroidRibbonHelper.LOCKSCREEN], true), 0));
        updateTargets();
    ...
    private void torchOff() {
        Intent intent = new Intent("com.tripndroid.torch.INTENT_TORCH_OFF");
        intent.setComponent(ComponentName.unflattenFromString
                ("com.tripndroid.Torch/.TorchReceiver"));
        intent.setAction("com.tripndroid.torch.INTENT_TORCH_OFF");
    ...
    final Runnable startTorch = new Runnable () {
        public void run() {
            ...
            if (!torchActive && !mGlowTorchOn) {
                mGlowTorchOn = true;
                vibrate();
                Intent intent = new Intent("com.tripndroid.torch.INTENT_TORCH_ON");
                intent.setComponent(ComponentName.unflattenFromString
                        ("com.tripndroid.Torch/.TorchReceiver"));
                intent.setAction("com.tripndroid.torch.INTENT_TORCH_ON");
                mContext.sendBroadcast(intent);
            }
        }
    };
