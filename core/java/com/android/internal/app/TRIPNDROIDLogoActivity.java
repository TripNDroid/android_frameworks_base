...
public class TRIPNDROIDLogoActivity extends Activity {
    Toast mToast;
    ImageView mContent;
    int mCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContent.setImageResource(com.android.internal.R.drawable.tripndroidlogo_alt);
        ...
        mContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mToast.show();
                mContent.setImageResource(com.android.internal.R.drawable.tripndroidlogo);
            }
        });
            ...
            public boolean onLongClick(View v) {
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .addCategory("com.android.internal.category.TRIPNDROIDLOGO"));
                        //.setClassName("com.android.systemui","com.android.systemui.UnicornSack"));
                } catch (ActivityNotFoundException ex) {
                    android.util.Log.e("TRIPNDROIDLogoActivity", "Couldn't find a sack of unicorns.");
                }
                finish();
                return true;
            }
