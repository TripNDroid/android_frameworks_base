...
import com.android.systemui.tripndroid.AwesomeAction;
import com.android.internal.util.tripndroid.TripndroidRibbonHelper;
import com.android.systemui.tripndroid.TripndroidSwipeRibbon;
...
public class PhoneStatusBar extends BaseStatusBar {
    ...
    private TripndroidSwipeRibbon mTripndroidSwipeRibbonLeft;
    private TripndroidSwipeRibbon mTripndroidSwipeRibbonRight;
    private TripndroidSwipeRibbon mTripndroidSwipeRibbonBottom;
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (mHasSettingsPanel) {
            ...
            mTripndroidSwipeRibbonBottom = new TripndroidSwipeRibbon(mContext,null,"bottom");
            mTripndroidSwipeRibbonLeft = new TripndroidSwipeRibbon(mContext,null,"left");
            mTripndroidSwipeRibbonRight = new TripndroidSwipeRibbon(mContext,null,"right");
            ...
            mTripndroidSwipeRibbonLeft.setControllers(mBluetoothController, mNetworkController, mBatteryController,
                    mLocationController, null);
            mTripndroidSwipeRibbonRight.setControllers(mBluetoothController, mNetworkController, mBatteryController,
                    mLocationController, null);
...
//        }
    ...
    public void disable(int state) {
        ...
        mTripndroidSwipeRibbonBottom.setDisabledFlags(state);
        mTripndroidSwipeRibbonLeft.setDisabledFlags(state);
        mTripndroidSwipeRibbonRight.setDisabledFlags(state);
...
//            mHandler.post(mStartRevealAnimation);
    ...
    public void updateRibbonTargets() {
            ...
            if (mRibbonQS != null) {
                ...
                mRibbonQS.addView(TripndroidRibbonHelper.getRibbon(mContext,
                    Settings.System.getArrayList(cr,
                         Settings.System.RIBBON_TARGETS_SHORT[TripndroidRibbonHelper.QUICK_SETTINGS]),
                    Settings.System.getArrayList(cr,
                         Settings.System.RIBBON_TARGETS_LONG[TripndroidRibbonHelper.QUICK_SETTINGS]),
                    Settings.System.getArrayList(cr,
                         Settings.System.RIBBON_TARGETS_ICONS[TripndroidRibbonHelper.QUICK_SETTINGS]),
                    Settings.System.getBoolean(cr,
                         Settings.System.ENABLE_RIBBON_TEXT[TripndroidRibbonHelper.QUICK_SETTINGS], true),
                    Settings.System.getInt(cr,
                         Settings.System.RIBBON_TEXT_COLOR[TripndroidRibbonHelper.QUICK_SETTINGS], -1),
                    Settings.System.getInt(cr,
                         Settings.System.RIBBON_ICON_SIZE[TripndroidRibbonHelper.QUICK_SETTINGS], 0),
                    Settings.System.getInt(cr,
                         Settings.System.RIBBON_ICON_SPACE[TripndroidRibbonHelper.QUICK_SETTINGS], 5),
                    Settings.System.getBoolean(cr,
                         Settings.System.RIBBON_ICON_VIBRATE[TripndroidRibbonHelper.QUICK_SETTINGS], true),
                    Settings.System.getBoolean(cr,
                         Settings.System.RIBBON_ICON_COLORIZE[TripndroidRibbonHelper.QUICK_SETTINGS], false), 0));
            }
            mRibbonNotif.removeAllViews();
            mRibbonNotif.addView(TripndroidRibbonHelper.getRibbon(mContext,
                Settings.System.getArrayList(cr,
                     Settings.System.RIBBON_TARGETS_SHORT[TripndroidRibbonHelper.NOTIFICATIONS]),
                Settings.System.getArrayList(cr,
                     Settings.System.RIBBON_TARGETS_LONG[TripndroidRibbonHelper.NOTIFICATIONS]),
                Settings.System.getArrayList(cr,
                     Settings.System.RIBBON_TARGETS_ICONS[TripndroidRibbonHelper.NOTIFICATIONS]),
                Settings.System.getBoolean(cr,
                     Settings.System.ENABLE_RIBBON_TEXT[TripndroidRibbonHelper.NOTIFICATIONS], true),
                Settings.System.getInt(cr,
                     Settings.System.RIBBON_TEXT_COLOR[TripndroidRibbonHelper.NOTIFICATIONS], -1),
                Settings.System.getInt(cr,
                     Settings.System.RIBBON_ICON_SIZE[TripndroidRibbonHelper.NOTIFICATIONS], 0),
                Settings.System.getInt(cr,
                     Settings.System.RIBBON_ICON_SPACE[TripndroidRibbonHelper.NOTIFICATIONS], 5),
                Settings.System.getBoolean(cr,
                     Settings.System.RIBBON_ICON_VIBRATE[TripndroidRibbonHelper.NOTIFICATIONS], true),
                Settings.System.getBoolean(cr,
                     Settings.System.RIBBON_ICON_COLORIZE[TripndroidRibbonHelper.NOTIFICATIONS], false), 0));
    }
    ...
    public void setImeWindowStatus(IBinder token, int vis, int backDisposition) {
        ...
        mTripndroidSwipeRibbonBottom.setNavigationIconHints(vis);
        mTripndroidSwipeRibbonLeft.setNavigationIconHints(vis);
        mTripndroidSwipeRibbonRight.setNavigationIconHints(vis);
...
//            Slog.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
   ...
   class SettingsObserver extends ContentObserver {
		...
		void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_SHORT[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_LONG[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_ICONS[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ENABLE_RIBBON_TEXT[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TEXT_COLOR[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_COLORIZE[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SIZE[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SPACE[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_VIBRATE[TripndroidRibbonHelper.NOTIFICATIONS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_SHORT[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_LONG[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TARGETS_ICONS[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ENABLE_RIBBON_TEXT[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SIZE[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_SPACE[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_VIBRATE[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_ICON_COLORIZE[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.RIBBON_TEXT_COLOR[TripndroidRibbonHelper.QUICK_SETTINGS]), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
