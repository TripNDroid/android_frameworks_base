...
public class NotificationPanel extends RelativeLayout implements StatusBarPanel,
    ...
    public void setBar(TabletStatusBar b) {
        ...
        if (mToggleManager != null && mBar != null) {
            ...
            mTripndroidSwipeRibbonLeft.setControllers(mBar.mBluetoothController,mBar.mNetworkController, mBar.mBatteryController,
                mBar.mLocationController, null);
            mTripndroidSwipeRibbonRight.setControllers(mBar.mBluetoothController,mBar.mNetworkController, mBar.mBatteryController,
                mBar.mLocationController, null);
        }
    }
