...
import com.android.internal.util.tripndroid.NavBarHelpers;
...
public class AppWindow extends LinearLayout {
    ...
    public void createWindowView() {
        ...
        View windowView = View.inflate(mContext, R.layout.tripndroid_app_window, null);
    ...
    private void setupWindow() {
        ...
        gv = TripndroidRibbonHelper.getGridView(mContext, mApps, mAppInfo, mTextColor, mColumns, mPad);
