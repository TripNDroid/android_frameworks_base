...
package com.android.systemui.tripndroid;
...
import com.android.internal.util.tripndroid.AwesomeAnimationHelper;
import com.android.internal.util.tripndroid.BackgroundAlphaColorDrawable;
import com.android.systemui.tripndroid.RibbonGestureCatcherView;
import static com.android.systemui.statusbar.toggles.ToggleManager.*;
import com.android.systemui.statusbar.toggles.*;

public class TripndroidSwipeRibbon extends LinearLayout {
    ...
    public TripndroidSwipeRibbon(Context context, AttributeSet attrs, String location) {
        super(context, attrs);
        mContext = context;
        mLocation = location;
        setRibbonNumber();
    ...
    public void createRibbonView() {
        ...
        View ribbonView = View.inflate(mContext, R.layout.tripndroid_swipe_ribbon, null);
    ...
    private void setupRibbon() {
        ...
        if (mLocation.equals("bottom")) {
            ...
            hsv = TripndroidRibbonHelper.getRibbon(mContext,
            ...
            mRibbonSV = TripndroidRibbonHelper.getVerticalRibbon(mContext,
    ...
    private void addToggleManagers() {
        ...
        if (length > 0) {
            ...
            mTogglesSV.addView(targetsLayout, TripndroidRibbonHelper.PARAMS_TARGET_SCROLL);
